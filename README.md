...
- **Interactive Contact Hub**: Dedicated contact page with social media integration (LinkedIn, GitHub) and a functional message system.
...
```text
/potr
├── /frontend   # React applications & Styles
...
```bash
git clone https://github.com/Supun200110/portfolio.git
cd portfolio
```
...
- [GitHub](https://github.com/Supun200110)

---
*Designed with passion and powered by modern web technologies.*
